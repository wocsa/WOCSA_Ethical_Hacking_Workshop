 ...
 *
 * Board: ESP32-C6 (NimBLE BLE stack). Differs from needle_in_the_sand.ino in
 * two places only: the I2C pins / OLED constructor, and the CCCD - NimBLE
 * creates the 0x2902 descriptor automatically and ships no BLE2902.h.
 */
...
void setup() {
  ...
  // NimBLE adds the 0x2902 CCCD automatically for NOTIFY characteristics
