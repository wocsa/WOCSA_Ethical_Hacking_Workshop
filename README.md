...
- **CyberRange**: A deployable Docker lab environment simulating a small company network (DMZ with public services, segregated database tier, intranet with user workstations reachable only through a WireGuard VPN). Based on classic images (Juice Shop, DVWA, Metasploitable2), it is the shared infrastructure of the [Juice Shop](WEB/JuiceShop/JuiceShop.md), [Nmap](Network/NMAP/NMAP_fundamentals.md), [Bettercap MITM](MITM/Bettercap/MITM_bettercap.md) and [AI offensive](AI/offensive/README.md) workshops.
